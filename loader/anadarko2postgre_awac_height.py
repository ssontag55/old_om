...
for line in inlines:
	...
	if(startatLine<15):
		...
		#exit();
		try:
			curs.execute("insert into data.data_values(collection_date,station_id,sensor_id,value21) values ('"+valuelist[0]+"',"+str(stationID)+","+str(sensorID)+","+str(valuelist[1]).replace('\n','')+");")
			totalRecords+=1
		except:
