...
for line in inlines:
	...
	if(startatLine<18):
		...
		print valuelist[0]
		#print "insert into data.data_val(date_collect,deployment_id, station_id,sensor_id,value16,value20,value17,value18,value19) values ('"+valuelist[0]+"',"+str(deploymentID)+","+str(stationID)+","+str(sensorID)+","+str(valuelist[1])+","+str(valuelist[2])+","+str(valuelist[3])+","+str(valuelist[4])+","+str(valuelist[5])+");"
		#exit();
		try:
			curs.execute("insert into data.data_values(collection_date, station_id,sensor_id,value16,value20,value17,value18,value19) values ('"+valuelist[0]+"',"+str(stationID)+","+str(sensorID)+","+str(valuelist[1])+","+str(valuelist[2])+","+str(valuelist[3])+","+str(valuelist[4])+","+str(valuelist[5])+");")
			totalRecords+=1
		except:
