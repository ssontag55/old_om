...
for line in inlines:
	...
	if(startatLine<14):
		...
		print valuelist[0]
		#print "insert into data.data_values(collection_date, station_id,sensor_id,value3,value4,value5,value6,value7,value11,value9,value8,value12,value10,value13,value14,value15) values ('"+str(valuelist[0])+"',"+str(stationID)+","+str(sensorID)+","+str(valuelist[1])+","+str(valuelist[2])+","+str(valuelist[3])+","+str(valuelist[4])+","+str(valuelist[5])+","+str(valuelist[6])+","+str(valuelist[7])+","+str(valuelist[8])+","+str(valuelist[9])+","+str(valuelist[10])+","+str(valuelist[11])+","+str(valuelist[12])+","+str(valuelist[13]).replace('\n','')+");"
		#curs.execute("insert into data.data_values(collection_date, station_id,sensor_id,value3,value4,value5,value6,value7,value11,value9,value8,value12,value10,value13,value14,value15) values ('"+str(valuelist[0])+"',"+str(stationID)+","+str(sensorID)+","+str(valuelist[1])+","+str(valuelist[2])+","+str(valuelist[3])+","+str(valuelist[4])+","+str(valuelist[5])+","+str(valuelist[6])+","+str(valuelist[7])+","+str(valuelist[8])+","+str(valuelist[9])+","+str(valuelist[10])+","+str(valuelist[11])+","+str(valuelist[12])+","+str(valuelist[13]).replace('\n','')+");")
		#exit();
		try:
			#curs.execute("insert into data.data_values(collection_date, station_id,sensor_id,value3,value4,value5,value6,value7,value11,value9,value8,value12,value10,value13,value14,value15) values ('"+str(valuelist[0])+"',"+str(stationID)+","+str(sensorID)+","+str(valuelist[1])+","+str(valuelist[2])+","+str(valuelist[3])+","+str(valuelist[4])+","+str(valuelist[5])+","+str(valuelist[6])+","+str(valuelist[7])+","+str(valuelist[8])+","+str(valuelist[9])+","+str(valuelist[10])+","+str(valuelist[11])+","+str(valuelist[12])+","+str(valuelist[13]).replace('\n','')+");")
			curs.execute("insert into data.data_values(collection_date,station_id,sensor_id,value3,value4,value5,value6,value7,value11,value9) values ('"+valuelist[0]+"',"+str(stationID)+","+str(sensorID)+","+str(valuelist[1])+","+str(valuelist[2])+","+str(valuelist[3])+","+str(valuelist[4])+","+str(valuelist[5])+","+str(valuelist[6])+","+str(valuelist[7])+");")
